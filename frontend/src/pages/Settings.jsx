    ...
    <div className="max-w-3xl space-y-8 animate-fade-in-down">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 flex items-center">
          <SettingsIcon className="w-6 h-6 mr-3 text-blue-600" /> Cài đặt Hệ thống
        </h1>
        <p className="text-gray-500 mt-2 text-sm">Quản lý cấu hình kết nối và giới hạn tài nguyên của Gateway.</p>
      </div>

      <div className="card p-6 relative overflow-hidden">
        {!isAdmin && (
          <div className="absolute top-0 right-0 p-4">
            <span className="flex items-center text-xs font-semibold text-yellow-700 bg-yellow-50 px-3 py-1.5 rounded-full border border-yellow-200">
        ...
        <div className="space-y-4 pt-2">
          <h3 className="text-lg font-bold text-gray-900 flex items-center mb-4">
            <Activity className="w-5 h-5 mr-2 text-blue-600" /> Traffic & Limits
          </h3>
        ...
        <div className="space-y-4 pt-6 border-t border-gray-200 mt-6">
          ...
          <div>
            ...
            <input 
              ...
              disabled={!isAdmin}
              className="input-field disabled:opacity-50 disabled:bg-gray-100 font-mono text-sm"
